...
func (_m *Repository) CheckJWT(ctx context.Context, Id uuid.UUID) (*domain.Verification, errs.Error) {
...
func (_m *Repository) CheckVerified(ctx context.Context, Id uuid.UUID) (*bool, errs.Error) {
	ret := _m.Called(ctx, Id)
...
func (_m *Repository) CreateUser(ctx context.Context, model *domain.User) errs.Error {
...
func (_m *Repository) CreateVerification(ctx context.Context, model *domain.Verification) errs.Error {
	ret := _m.Called(ctx, model)
...
// GetUserFullData provides a mock function with given fields: ctx, username, email
func (_m *Repository) GetUserFullData(ctx context.Context, username string, email string) (*domain.User, errs.Error) {
...
func (_m *Repository) StoreJWT(ctx context.Context, jwt string, Id uuid.UUID) errs.Error {
...
func (_m *Repository) UpdateVerification(ctx context.Context, Id uuid.UUID) errs.Error {
	ret := _m.Called(ctx, Id)
